...
final class CreateFile
{
    ...
    private function createDocxDocument(array $data, ?string $name = null): string
    {
        ...
        $customVariablesJson = $this->normalizeCustomVariablesForMetadata($data['replacements'] ?? []);
    ...
    private function normalizeCustomVariablesForMetadata(mixed $replacements): string
    {
        if (!is_array($replacements)) {
        ...
        return json_encode($pairs, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?: '[]';
    }
