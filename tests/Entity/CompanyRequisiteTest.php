...
final class CompanyRequisiteTest extends TestCase
{
    ...
    public function testGettersAndSetters(): void
    {
        ...
        $e->setCompanyNameEn('Test LLC');
        $e->setCompanyNameRu('Тест ООО');
        $e->setCode('123456789');
        $e->setCategory('Category');
        $e->setAddress('Gatvė 1');
        $e->setAddressEn('Street 1');
        $e->setAddressRu('Улица 1');
        $e->setCityOrDistrict('Vilnius');
        $e->setCityOrDistrictEn('Vilnius');
        $e->setCityOrDistrictRu('Вильнюс');
        $e->setManagerType('vadovas');
        $e->setManagerGender('Vyras');
        $e->setManagerFirstName('Jonas');
        $e->setManagerLastName('Jonaitis');
        $e->setManagerLastNameEn('Jonaitis');
        $e->setManagerLastNameRu('Йонайтис');
        ...
        $this->assertSame('Test LLC', $e->getCompanyNameEn());
        $this->assertSame('Тест ООО', $e->getCompanyNameRu());
        $this->assertSame('123456789', $e->getCode());
        $this->assertSame('Category', $e->getCategory());
        $this->assertSame('Gatvė 1', $e->getAddress());
        $this->assertSame('Street 1', $e->getAddressEn());
        $this->assertSame('Улица 1', $e->getAddressRu());
        $this->assertSame('Vilnius', $e->getCityOrDistrict());
        $this->assertSame('Vilnius', $e->getCityOrDistrictEn());
        $this->assertSame('Вильнюс', $e->getCityOrDistrictRu());
        ...
        $this->assertSame('Jonaitis', $e->getManagerLastNameEn());
        $this->assertSame('Йонайтис', $e->getManagerLastNameRu());
    ...
    public function testNullableOptionalFields(): void
    {
        ...
        $this->assertNull($e->getCompanyNameEn());
        $this->assertNull($e->getCompanyNameRu());
        $this->assertNull($e->getAddress());
        $this->assertNull($e->getAddressEn());
        $this->assertNull($e->getAddressRu());
        $this->assertNull($e->getCityOrDistrict());
        $this->assertNull($e->getCityOrDistrictEn());
        $this->assertNull($e->getCityOrDistrictRu());
        ...
        $this->assertNull($e->getManagerLastNameEn());
        $this->assertNull($e->getManagerLastNameRu());
