...
final class CompanyController extends AbstractController
{
    ...
    public function update(int $id, Request $request, CompanyRequisiteRepository $repo): JsonResponse
    {
        ...
        if (array_key_exists('managerType', $data)) {
            $company->setManagerType($data['managerType']);
        }
        if (array_key_exists('managerGender', $data)) {
            $g = $data['managerGender'];
            $company->setManagerGender(
                $g !== null && trim((string) $g) !== '' ? (string) $g : null
            );
        } elseif (array_key_exists('managerType', $data)) {
