...
final class UserController extends AbstractController
{
    ...
    #[Route('/api/users/all', name: 'app_user_all', methods: ['GET'])]
    ...
    #[Route('/api/users/{id}', name: 'app_user_get', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/api/users/{id}/update', name: 'app_user_update', methods: ['POST', 'PUT'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/api/users/{id}/delete', name: 'app_user_delete', methods: ['POST', 'DELETE'], requirements: ['id' => '\d+'])]
